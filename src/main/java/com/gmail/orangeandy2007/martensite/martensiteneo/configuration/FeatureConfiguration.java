...
public class FeatureConfiguration {
    ...
    public static final ModConfigSpec.ConfigValue<Boolean> NoSoundPoolWarn;
    static {
        ...
        NoSoundPoolWarn = BUILDER.comment("Disable the warning log created by sound pool limit").define("No Sound warning", true);
